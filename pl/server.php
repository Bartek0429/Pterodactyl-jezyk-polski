...
return [
    'index' => [
        ...
        'header' => 'Konsola serwera',
        'header_sub' => 'Kontroluj swój serwer w czasie rzeczywistym.',
    ],
    'schedule' => [
        'header' => 'Menedżer harmonogramu',
        'header_sub' => 'Zarządzaj wszystkimi harmonogramami tego serwera w jednym miejscu.',
        'current' => 'Bieżące harmonogramy',
        'new' => [
        ...
        'manage' => [
            'header' => 'Zarządzaj harmonogramem',
            'submit' => 'Aktualizuj harmonogram',
    ...
    'users' => [
        ...
        'header_sub' => 'Kontroluj, kto może uzyskać dostęp do Twojego serwera.',
    ...
    'files' => [
        ...
        'header' => 'Web FTP',
        'header_sub' => 'Zarządzaj wszystkimi swoimi plikami bezpośrednio z sieci.',
    ...
    'config' => [
        'name' => [
            'header' => 'Nazwa serwera',
            'header_sub' => 'Zmień nazwę tego serwera.',
            'details' => 'Nazwa serwera stanowi jedynie odniesienie do tego serwera na panelu i nie wpływa na żadne konfiguracje serwera, które mogą być wyświetlane użytkownikom w grach.',
        ],
        'startup' => [
            'header' => 'Konfiguracja startowa',
            'header_sub' => 'Kontroluj argumenty uruchamiania serwera.',
            'command' => 'Startup Command',
            'edit_params' => 'Edytuj parametry',
            'update' => 'Zaktualizuj parametry uruchamiania',
            'startup_regex' => 'Input Rules',
            'edited' => 'Zmienne startowe zostały pomyślnie edytowane. Zaczną obowiązywać przy następnym uruchomieniu tego serwera.',
        ],
        'sftp' => [
            'header' => 'Konfiguracja SFTP',
            'header_sub' => 'Szczegóły konta dla połączeń SFTP.',
            'details' => 'Szczegóły SFTP',
            'conn_addr' => 'Adres połączenia',
            'warning' => 'Hasło SFTP to hasło do Twojego konta. Upewnij się, że klient jest skonfigurowany do korzystania z SFTP, a nie FTP lub FTPS do połączeń, istnieje różnica między protokołami.',
        ],
        'database' => [
            'header' => 'Databases',
            'header_sub' => 'Wszystkie bazy danych dostępne dla tego serwera.',
            'your_dbs' => 'Configured Databases',
            'host' => 'MySQL Host',
            'reset_password' => 'Reset Password',
            'no_dbs' => 'Brak baz danych na liście dla tego serwera.',
            'add_db' => 'Dodaj nową bazę danych.',
        ],
        'allocation' => [
